...
var (
	...
	RbBuildName1                = "cli-rb-build1"
	RbBuildName2                = "cli-rb-build2"
	RbRbName1                   = "cli-rb-rb1"
	RbRbName2                   = "cli-rb-rb2"
	RbRbName3                   = "cli-rb-rb3"
...
func GetExpectedReleaseBundlesArtifacts() []string {
	return []string{
		RtProdRepo + "/a1.in",
		RtProdRepo + "/a2.in",
		RtProdRepo + "/a3.in",
